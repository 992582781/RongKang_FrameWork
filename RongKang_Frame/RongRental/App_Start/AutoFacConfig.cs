...
namespace RongRental.App_Start
{
    public class AutoFacConfig
    {
        public static void Register()
        {
            ...
            Assembly controllerAss = Assembly.Load("RongRental");
            ...
            Assembly repositoryAss = Assembly.Load("RongKang_Dal");
            ...
            Assembly servicesAss = Assembly.Load("RongKang_Bll");
